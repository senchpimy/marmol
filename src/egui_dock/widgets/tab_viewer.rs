use crate::egui_dock::{NodeIndex, SurfaceIndex, TabStyle};
use egui::{Id, Ui, WidgetText, Image};

/// Defines how a tab should behave and be rendered inside a [`Tree`](crate::egui_dock::Tree).
pub trait TabViewer {
    ...
    fn icon(&mut self, _tab: &mut Self::Tab) -> Option<Image<'static>> {
        None
    }
    ...
    ///
    /// `_surface` and `_node` specify which [`Surface`](crate::egui_dock::Surface) and [`Node`](crate::egui_dock::Node)
    ...
    ///
    /// `_surface` and `_node` specify which [`Surface`](crate::egui_dock::Surface) and on which
    /// [`Node`](crate::egui_dock::Node) this particular add button was pressed.
    ...
    ///
    /// This requires that [`DockArea::show_add_buttons`](crate::egui_dock::DockArea::show_add_buttons) and
    /// [`DockArea::show_add_popup`](crate::egui_dock::DockArea::show_add_popup) are set to `true`.
    ...
    /// [`TabBarStyle::bg_fill`](crate::egui_dock::TabBarStyle::bg_fill).
