...
/// Wrapper around indices to the collection of nodes inside a [`Tree`](crate::egui_dock::Tree).
...
impl NodeIndex {
    ...
    ///
    /// In the context of a [`Tree`](crate::egui_dock::Tree), this will be the node that contains all other nodes.
    ///
    /// # Examples
    ///
