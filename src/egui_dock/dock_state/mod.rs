...
pub mod surface;
/// Specifies text displayed in different elements of the [`DockArea`](crate::egui_dock::DockArea).
...
use crate::egui_dock::{Node, NodeIndex, Split, TabDestination, TabIndex, TabInsert, Translations, Tree};
...
pub struct DockState<Tab> {
    ...
    /// Contains translations of text shown in [`DockArea`](crate::egui_dock::DockArea).
...
impl<Tab> DockState<Tab> {
    ...
    /// Sets translations of text later displayed in [`DockArea`](crate::egui_dock::DockArea).
