...
pub use crate::egui_commonmark_backend::RenderHtmlFn;
pub use crate::egui_commonmark_backend::RenderMathFn;
pub use crate::egui_commonmark_backend::alerts::{Alert, AlertBundle};
pub use crate::egui_commonmark_backend::misc::CommonMarkCache;
...
#[doc(hidden)]
pub use crate::egui_commonmark_backend;

use crate::egui_commonmark_backend::*;
...
impl<'f> CommonMarkViewer<'f> {
    ...
    pub fn process_link(mut self, func: Option<&'f crate::egui_commonmark_backend::misc::ProcessLinkFn>) -> Self {
        self.options.process_link = func;
        self
    }
    ...
    /// [`show`]: crate::egui_commonmark::CommonMarkViewer::show
