...
fn rich_text_from_style(text: &str, style: &easy_mark::Style) -> RichText {
    ...
    if heading != Heading::None && !small {
        rich_text = match heading {
            Heading::H1 => rich_text.strong().size(20.0),
            Heading::H2 => rich_text.strong().size(18.0),
            Heading::H3 => rich_text.strong().size(16.0),
            Heading::H4 => rich_text.strong().size(14.0),
